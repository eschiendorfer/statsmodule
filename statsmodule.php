 ...
 * $this->l('Forecast')
 * $this->l('Full carts')
 * $this->l('Social titles distribution allows you to determine the percentage of social titles used by shoppers on your store.')
 * $this->l('Social titles distribution')
 * $this->l('Global')
 * $this->l('Good')
 * $this->l('Greater than')
 * $this->l('Group')
